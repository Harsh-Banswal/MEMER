...
* Real-Time Meme Estimation:** Uses Google MediaPipe on the backend with hardware-accelerated EGL rendering to extract 106-dimensional pose vectors (upper body, shoulders, elbows, wrists, and hand joints) at **35+ FPS**.
