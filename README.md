...
python scripts/download_memes.py "archive (2).zip"

# 3. Extract and cleanly append the Memotion Dataset ZIP
python scripts/download_memes.py "archive (3).zip"
```

Once merged, your `data/metadata.json` will safely hold **20,000+ unique templates** with isolated prefixes (e.g. `local_archive_2_...` and `local_archive_3_...`).

---

## 🏗️ Building the FAISS Index Database
